...
const THIRTY_DAYS_AGO = new Date(Date.now() - 30 * 86400_000)
  .toISOString()
  .slice(0, 10);
            ...
            {exports.map(
              ({
                ...
                <button
                  key={endpoint}
                  onClick={() =>
                    exportExcel({ endpoint, fileName, sheetName, title })
                  }
